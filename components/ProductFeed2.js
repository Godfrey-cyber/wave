...
const ProductFeed = ({products}) => {
    return (
        <div className="mx-auto px-20 my-4">
            <div className="flex justify-between bg-blue-400 py-3 px-4 rounded-t-md">
            ...
            <div className="bg-white rounded-md grid grid-flow-row-dense md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4  mx-auto transition-all duration-100">
