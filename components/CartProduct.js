...
import { PlusCircleIcon, HeartIcon, TrashIcon } from '@heroicons/react/outline';
                  ...
                  <Image src={image} objectfit="contain" width={80} height={100} alt="cart-product"/>
                    <div className="flex flex-col">
                        ...
                        <div className="flex space-x-4 justify-between">
                            <span onClick={addItemToBasket} className="lg:flex space-x-2 mt-2 items-center text-sm text-orange-400">
                            ...
                            <span onClick={removeItemFromBasket} className="lg:flex space-x-2 mt-2 items-center text-sm text-orange-400">
                            ...
                            <span onClick={addItemToWishlist} className="lg:flex space-x-2 mt-2 items-center text-sm text-orange-400">
                                <div><HeartIcon className="h-8 text-orange-400"/></div>
                              <p className="hidden lg:inline-flex text-sm text-orange-400 hover:cursor-pointer">ADD TO SAVED</p>
                            </span>
                        </div>
                    </div>
